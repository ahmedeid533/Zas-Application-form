...
function Navbar() {
	...
	return (
		<nav
			ref={ref}
			className={`bg-secondary fixed transition-all duration-300  z-40  w-full ${
		...
		>
			<div className="px-4 h-full mx-auto ">
				<div className="flex items-center h-full justify-center lg:justify-between px-6 md:px-16 py-3 relative">
					<button
						className="absolute left-0 top-1/2 transform -translate-y-1/2 cursor-pointer lg:hidden text-primary"
					...
					<div className="flex items-center h-full gap-4">
						<a
							...
							// 	navigate("/");
							// }}
							href="https://zasair.com/index.php"
							target="_blank"
							className="h-full cursor-pointer group relative "
						>
							<img
								src="https://zasair.com/imgs/mainLogo.png"
								className="h-full"
								alt="logo"
							/>
						</a>
					...
					<div className="lg:flex items-center justify-end gap-14 hidden">
						...
						<a
							...
							`}
							// onClick={() => {
							// 	navigate("/private-jet-aircatering-cairo");
							// }}
							href="https://zasair.com/services.php"
							target="_blank"
						>
							AVIATION SERVICES
						</a>
						<a
							...
							// 	}, 100);
							// }}
							href="https://zasair.com/locations.php"
							target="_blank"
						>
							OUR LOCATIONS
						</a>
						<a
							...
							`}
							// onClick={() => {
							// 	navigate("/inflight-meal-catering-egypt");
							// }}
							href="https://zasair.com/history.php"
							target="_blank"
						>
							ZAS HISTORY
						</a>
						<a
							...
							`}
							// onClick={() => {
							// 	navigate("https://zasair.com/contacts.php");
							// }}
							href="https://zasair.com/contacts.php"
							target="_blank"
						>
							CONTACT US
						</a>
			...
			<div
				className={`fixed h-screen w-screen   z-40 top-0  transition-all  duration-500 menu ${
					isMenuOpen ? "right-0 " : "right-full"
				} ${isBgActive ? "bg-[#00000040]" : "bg-transparent"}`}
			>
				<div className="  w-125 h-full px-6 py-5 max-w-3/4 bg-secondary flex">
					<div className="flex flex-col w-full gap-6">
						...
						<a
							className={`text-white text-xl hover:text-primary cursor-pointer duration-200 `}
						>
							CATERING
						</a>
						<a
